  ...
  >
    <div class="row">
      <div class="col-xs-12 bg">
        ...
        <div class="form-group row" style="marginTop:1em">
          <div class="col-xs-8" style="paddingRight:0">
            <input type="text" class="form-control" @keyup.13="setPage(page)" v-model="imgkeyword" placeholder="参赛号">
          </div>
          <div class="col-xs-4" style="paddingLeft:0">
            <button style="width:100%" type="button" @click="setPage(page)" class="btn btn-warning">搜索</button>
          </div>
        </div>

        <div class="photo-list baguetteBoxOne">
          <ul class="gallery">
            <li v-for="(item,index) in photoStore.photoalbum.list" style="width:50%;height:auto;float:left;padding:10px">
